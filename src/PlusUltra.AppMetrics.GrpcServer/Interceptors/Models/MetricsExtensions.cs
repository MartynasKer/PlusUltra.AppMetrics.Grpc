...
namespace PlusUltra.AppMetrics.GrpcServer.Interpectors
{
    public static class MetricsExtensions
    {
        ...
        public static void RequestCounterInc(this IMetrics metrics, GrpcMethodInfo method, double inc = 1d)
        {
        ...
        /// <param name="inc">Indicates by how much counter should be incremented. By default it's set to 1</param>
        public static void ResponseCounterInc(this IMetrics metrics, GrpcMethodInfo method, StatusCode code, double inc = 1d)
        {
        ...
        /// <param name="method">Information about the call</param>
        /// <param name="inc">Indicates by how much counter should be incremented. By default it's set to 1</param>
        public static void StreamReceivedCounterInc(this IMetrics metrics, GrpcMethodInfo method, double inc = 1d)
        {
        ...
        /// <param name="method">Information about the call</param>
        /// <param name="inc">Indicates by how much counter should be incremented. By default it's set to 1</param>
        public static void StreamSentCounterInc(this IMetrics metrics, GrpcMethodInfo method, double inc = 1d)
        {
        ...
        public static void RecordLatency(this IMetrics metrics, GrpcMethodInfo method, double value)
        {
